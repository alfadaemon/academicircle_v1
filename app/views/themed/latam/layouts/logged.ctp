<?php
/**
 * File name: logged.ctp
 * Project: academicircle
 * Creation: Feb 13, 2011
 *
 * @author lfaraya
 */
?>
...
<?php
	echo $html->meta('icon');
	echo $html->css('jquery-ui-1.8.15.custom');
	echo $html->css('layout');
	echo $javascript->link('jquery-1.6.2.min');
	echo $javascript->link('jquery-ui-1.8.15.custom.min');
...
<?php
	echo $html->image('logo.png', array('align'=>'middle', 'alt'=>"Latin American School"));
?>
</div>
<div id="pagewidth" >
<?
