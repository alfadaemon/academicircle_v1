...
<?php echo $form->create('ListMember');?>
	<fieldset>
 		<legend><?php __('Edit ListMember');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('ListMember.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('ListMember.id'))); ?></li>
