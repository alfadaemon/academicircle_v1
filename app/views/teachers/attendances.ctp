...
<table class="calendar">
  <tr  class="calendar-row">
      ...
      <?php
        echo $ajax->link(__d('logged', 'previous', true).' '.__d('logged', 'week', true),
                array('controller'=>'teachers', 'action'=>'attendances', $schedule, $section, $week-1),
  ...
  <tr<?php echo $class;?>>
      <td>
          ...
          <div class="rfloat">
          <?php
            echo $ajax->link( __d('logged', 'add', true), array('controller'=>'attendances', 'action' => 'add', $schedule, $student['Student']['id']),
                    array('id'=>'view'.$student['Student']['id'],  'update' => 'workAreaTeacher', 'indicator' => 'LoadingDiv', 'after' =>  "$('#workAreaTeacher').slideDown()" ));
            ...
            echo $ajax->button('view'.$student['Student']['id'], array('icons'=>array('secondary'=>'ui-icon-circle-plus'), 'text'=>false));
