...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller' => 'acos', 'action' => 'view', $aco['id'])); ?>
				<?php echo $html->link(__('Edit', true), array('controller' => 'acos', 'action' => 'edit', $aco['id'])); ?>
				<?php echo $html->link(__('Delete', true), array('controller' => 'acos', 'action' => 'delete', $aco['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $aco['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
